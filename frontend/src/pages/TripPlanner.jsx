            ...
            >
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-10">
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">The budget is exclusively allocated for activities and dining purposes.</p>
                    ...
                    >
                        <div className="flex items-center gap-3 mb-2">
                            <svg className="w-6 h-6 text-gray-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM12 12c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z" />
                            </svg>
